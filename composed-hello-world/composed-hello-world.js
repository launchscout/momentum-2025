...
function trampoline7() {
  ...
  const _interface_call_currentTaskID = startCurrentTask(2, false, 'get-stderr');
  const ret = getStderr();
...
function trampoline8() {
  ...
  const _interface_call_currentTaskID = startCurrentTask(2, false, 'get-stdin');
  const ret = getStdin();
...
function trampoline9() {
  ...
  const _interface_call_currentTaskID = startCurrentTask(2, false, 'get-stdout');
  const ret = getStdout();
...
function trampoline10(arg0) {
  ...
  const _interface_call_currentTaskID = startCurrentTask(2, false, 'exit');
  exit(variant0);
...
function trampoline12(arg0) {
  ...
  const _interface_call_currentTaskID = startCurrentTask(2, false, 'get-environment');
...
function trampoline13(arg0, arg1) {
  ...
  const _interface_call_currentTaskID = startCurrentTask(2, false, 'filesystem-error-code');
...
function trampoline14(arg0, arg1, arg2) {
  ...
  const _interface_call_currentTaskID = startCurrentTask(2, false, '[method]descriptor.write-via-stream');
  let ret;
  try {
...
function trampoline15(arg0, arg1) {
  ...
  const _interface_call_currentTaskID = startCurrentTask(2, false, '[method]descriptor.append-via-stream');
  let ret;
  try {
...
function trampoline16(arg0, arg1) {
  ...
  const _interface_call_currentTaskID = startCurrentTask(2, false, '[method]descriptor.get-type');
  let ret;
  try {
...
function trampoline17(arg0, arg1) {
  ...
  const _interface_call_currentTaskID = startCurrentTask(2, false, '[method]descriptor.stat');
  let ret;
  try {
...
function trampoline18(arg0, arg1) {
  ...
  const _interface_call_currentTaskID = startCurrentTask(2, false, '[method]output-stream.check-write');
  let ret;
  try {
...
function trampoline19(arg0, arg1, arg2, arg3) {
  ...
  const _interface_call_currentTaskID = startCurrentTask(2, false, '[method]output-stream.write');
  let ret;
  try {
...
function trampoline20(arg0, arg1) {
  ...
  const _interface_call_currentTaskID = startCurrentTask(2, false, '[method]output-stream.blocking-flush');
  let ret;
  try {
...
function trampoline21(arg0, arg1, arg2, arg3) {
  ...
  const _interface_call_currentTaskID = startCurrentTask(2, false, '[method]output-stream.blocking-write-and-flush');
  let ret;
  try {
    ret = { tag: 'ok', val: rsc0.blockingWriteAndFlush(result3)};
  } catch (e) {
...
function trampoline22(arg0) {
  ...
  const _interface_call_currentTaskID = startCurrentTask(2, false, 'get-directories');
...
function greet(arg0) {
  ...
  const _wasm_call_currentTaskID = startCurrentTask(2, false, 'exports5Greet');
  const ret = exports5Greet(ptr0, len0);
  endCurrentTask(2);
  ...
  let cstate = getOrCreateAsyncState(2);
